// work on creating props version of this code
//add links to the videos that explained props

// once the format is update and working with props then change the data.
// keep this to test work on adding the following; accordion drops, and modals in the drop down.
// create custom tailwind to add box shadow

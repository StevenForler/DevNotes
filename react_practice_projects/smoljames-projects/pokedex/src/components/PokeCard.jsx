...
export default function PokeCard(props) {
    ...
    const [data, setData] = useState(null) //being explicit with not having the information for a pokemon is important when coming back to a data set
    ...
    useEffect(() => {
        ...
        if (loading || !localStorage) { return } // guard clause to help remove parallel events. mainly to remove unnecessary loading

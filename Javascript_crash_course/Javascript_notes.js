...
function addStrings(string1, string2){ //you can also insert a default response to pass through incase you wanted to not put in a guard clause like below. eg. function addStrings(string1='default1', string2 ='default2')

    if(!string1 || !string2){ // this is known as a guard clause where you can put in a conditional statement to make sure that the end user if they miss something knows what happened.
        console.log('Hey, you missed an input or didn\'t input an expected response.')
        return // This keyword when a conditional statement is met you break the code and end its function. Usually seen to return in a loop but I think can be used here.
    }
...
function addStrings2(string1='default1', string2 ='default2'){

    let concatString = string1 + ' ' + string2
    console.log(concatString)
    return concatString //how the fuck does this work?! procedurally
}

let newString = addStrings2('hello', 'mum')
